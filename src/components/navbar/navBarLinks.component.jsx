...
export default function NavBarLinks(props) {
  ...
  return (
    <ul className="navBarLinks">
      ...
      <li>
        <Link onClick={onClick} to="/platform/zxSpectrum">
          <img src="https://db3pap005files.storage.live.com/y4mB_WvQb7Bmm5Q_Z2dZrL-aKiY1WylltKjXR10uzGz7qtt2lSE9_mfloMYv1ey2WJSQ8ZGyEoir-hD9rBJnX1pcJtXT584MD42yT64t9f6T39kg6EO9xjEH_Ki5ow0UhM3omcz1eNI1eJoP_JTlQgKK5WymWfT4sO5KxXTDBG7WihKJJcITH73EqHtuxGeCtcr?width=972&height=185&cropmode=none" alt="ZX Spectrum Logo" />
        </Link>
      </li>
    </ul>
  )
